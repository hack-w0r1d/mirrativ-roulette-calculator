 ...
 */
 (function () {
    ...
    var CSS = "" +
      ...
      "border-radius:10px;border-left:5px solid #d64545;" +
      "box-shadow:0 10px 30px rgba(0,0,0,.24);" +
      "padding:16px 34px 14px 16px;" +
      "}" +
      ".ghn-title{margin:0 0 6px;font-size:14px;font-weight:700;color:#d64545;}" +
      ".ghn-body{margin:0;font-size:13px;line-height:1.7;}" +
      ".ghn-body strong{color:#d64545;}" +
      ".ghn-link{color:#d64545;text-decoration:underline;}" +
      ...
      ".ghn-reopen{" +
      "position:fixed;top:23vh;right:0;z-index:2147483000;" +
