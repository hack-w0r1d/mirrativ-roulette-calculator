(function () {
  ...
  const formulaDefault = `
    <div>
      ...
      1マス: 40% / 2マス: 45% / 5マス: 10% / 10マス: 5%<br>
      期待値: 2.30 マス / 回
    </div>
    <div>
      <strong>有償10連・100連（1連あたり）</strong>
      2マス: 80% / 5マス: 13% / 10マス: 7%<br>
      期待値: 2.95 マス / 回
    </div>
    <div>
      <strong>ルーレット1周分のマス数</strong>
      FEVERタイム中: 65マス / FEVERなし: 85マス<br>
      ※ FEVERタイムはMAPの総マス数が変化します
    </div>
  `;
  const formulaFever = `
    <div>
      <strong>無償(100) / 有償(90)</strong>
      1マス: 40% / 2マス: 44.5% / 5マス: 10% / 10マス: 5% / 100マス: 0.5%<br>
      期待値: 2.79 マス / 回
    </div>
    <div>
      <strong>有償10連・100連（1連あたり）</strong>
      5マス: 73.5% / 7マス: 15% / 10マス: 11% / 100マス: 0.5%<br>
      期待値: 6.33 マス / 回
    </div>
    <div>
      <strong>ルーレット1周分のマス数</strong>
